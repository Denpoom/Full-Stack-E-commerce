                ...
                <div className="relative mt-8 flex flex-col  items-center">
                    <div className="mt-5 relative lg:max-w-screen-2xl w-full">
                        <div className="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-lg">
                            <h1 className="font-bold tracking-wider text-3xl mb-8 text-gray-800"> Payment Form</h1>
                                ...
                                <div className="col-6 ">
                                    ...
                                    <div className="-mx-3 md:flex mb-6">
                                            <div className="md:w-full px-3">
                                                ...
                                                <input type="text" className="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="name" />
                                            </div>
                                        </div>
                                        <div className="-mx-3 md:flex mb-6">
                                            <div className="md:w-3/5 px-3 mb-6 md:mb-0">
                                                ...
                                                <input type="text" className="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="0000 0000 0000 0000" />
                                            </div>
                                            <div className="md:w-1/5 px-3 mb-6 md:mb-0">
                                                ...
                                                <input type="phone" className="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="MM/YY" />
                                            ...
                                            <label className="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="grid-first-name">
                                                ...
                                                <input type="phone" className="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="CVC" />
                                            </div>
                                        </div>
                                        <div className="-mx-3 md:flex mb-6">
                                            ...
                                            <Link to="" className="flex justify-center w-full px-10 py-2 mt-6 font-medium text-white uppercase bg-blue-800 rounded-full item-center hover:bg-blue-700 focus:shadow-outline focus:outline-none">
