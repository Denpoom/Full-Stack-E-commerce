                ...
                <div className="relative mt-8 flex flex-col lg:justify-center items-center">
                    <div className="mt-5 relative lg:max-w-screen-2xl w-full">
                        <div className="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-lg">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <p type="submit" className="text-left text-danger"> <small>(Remove item)</small></p>
                                        </td>
                            ...
                            <hr></hr>
                            <div className="row">
                                <div className="col-10 text-right  uppercase"><b>Total</b></div>
                                <div className="col-2 text-right"><b>60.00€</b></div>
