            ...
            <section >
                ...
                <div class="section py-28 w-full scree border grid md:grid-cols-2 bg-gray-200 text-gray-800">
                    <div class="subsec flex-none overflow-hidden max-h-96">
                        <img class="w-full" src="https://www.paldesk.com/wp-content/uploads/2020/05/6-Way-to-sneak-in-sales-promotion-messages-into-live-chat-customer-service-in-ecommerce-1.png" alt="" />
                    </div>
