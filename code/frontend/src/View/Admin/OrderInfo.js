                        ...
                        <div className="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-lg">
                                ...
                                <a href="orderadmin">
                                    ...
                                    <div class="mt-1 col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-11 px-6 py-4 border rounded bg-gray-100 shadow-md"><span class="h3"><i class="fas fa-chart-pie"></i> จำนวนออร์เดอร์</span><hr></hr><br></br> 10 ชิ้น </div>
                                        ...
                                        <div class="mt-5 row">
                                            ...
                                            <a href="">
                                                ...
                                                <i class="fas fa-sync-alt"></i> Click for update order !!
                                                </button>
                                            </a>                                                                                  
                                        </div>
                                    </div>
